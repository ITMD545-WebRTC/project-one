...
async function scrapeData() {
  ...
  try {
    ...
    //await page.goto('./output/worldometers_data.html');
    //await page.goto('C:/Users/Jimmy/Desktop/IIT/ITMD545/project-one/output/worldometers_data.html');
...
async function update() {
  ...
  fs.writeFile('./output/worldometers_data.txt', result.str_update, {
    encoding: "utf-8"
  }, function(err) {
    if (err) throw (err);
